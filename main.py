...
try:
    ...
    starting_letter = {starting_word[i] for i in starting_poses}      
    random_letters = random.sample(list(known_letters), len(known_letters))
    ...
    print()
    for i in range(len(known_letters)):
        if random_letters[i] in starting_letter:
